import { Table, Thead, Tbody, Tr, Th, Td, Box, Checkbox } from "@chakra-ui/react";
      ...
      <Table size="lg" variant="simple" border="1px solid" borderColor="gray.400" width="100%">
        <Thead>
          <Tr>
            ...
            <Th border="1px solid" borderColor="gray.400" textAlign="center" verticalAlign="middle">Selected</Th>
          </Tr>
        </Thead>
        <Tbody>
          {Array.from({ length: 5 }, (_, index) => (
            <Tr key={index}>
              ...
              <Td border="1px solid" borderColor="gray.400" textAlign="center" verticalAlign="middle">
